...
* An eCommerce platform or custom integration supporting the [`PlaceOrder`](place-order.md) mutation of the [Labels API](../label/overview.md), either:
...
* A custom integration implementing both our [Rates API](../rate/overview.md) and the [`PlaceOrder`](place-order.md) mutation of our [Labels API](../label/overview.md)
...
2. A custom integration of the ShipperHQ [Rates API](../rate/overview.md) and the [`PlaceOrder`](place-order.md) mutation of the [Labels API](../label/overview.md).
