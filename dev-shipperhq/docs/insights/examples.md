...
<p><a target="_blank" href="/examples/shipperhq-insights.postman_collection.json" download="shipperhq-insights.postman_collection.json">Download the ShipperHQ Advanced Shipment Details API Collection <i class="fa fa-arrow-right"></i></a></p>

### Usage
Once you have Postman installed and have downloaded the ShipperHQ Advanced Shipment Details API Collection, open Postman, click File > Import, and choose the ShipperHQ Advanced Shipment Details collection. This will import the collection and the examples included in it.

You will need to set up your credentials within the collection by clicking on the Collection in the Postman Collections list, clicking Variables, entering your Access Token, and clicking the "Save" icon. You'll also want to confirm your Website Scope is LIVE or, if not, change it to the appropriate scope. Now, by choosing any of the examples you'll be able to run Advanced Shipment Details API requests.

## Basic Example

We've put together a basic example of an Advanced Shipment Details API request below showing a minimal amount of information that can be retrieved.
